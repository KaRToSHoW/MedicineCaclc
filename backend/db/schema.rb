...
ActiveRecord::Schema[7.2].define(version: 2025_12_15_132346) do
  ...
  create_table "calculation_results", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["calculator_id"], name: "index_calculation_results_on_calculator_id"
  ...
  create_table "usage_statistics", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["calculator_id"], name: "index_usage_statistics_on_calculator_id"
